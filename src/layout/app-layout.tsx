...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'inventory-manager', 'it-staff', 'finance-manager', 'end-customer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Finances', path: '/finances', entity: 'finance', service: AccessServiceEnum.PROJECT, icon: FiDollarSign },
    {
      name: 'Inventories',
      path: '/inventories',
      entity: 'inventory',
