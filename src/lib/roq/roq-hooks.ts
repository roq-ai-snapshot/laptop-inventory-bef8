...
export function useFinanceFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useFinanceFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.finance.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useFinanceCount<T extends Prisma.financeCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.financeCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useFinanceCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.finance.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useFinanceFindManyWithCount<
  T extends Prisma.financeFindManyArgs,
  R extends { data: GetFindResult<Prisma.$financePayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.financeFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useFinanceFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.finance.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useFinanceFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useFinanceFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.finance.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function usePurchaseFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['usePurchaseFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.purchase.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function usePurchaseCount<T extends Prisma.purchaseCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.purchaseCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['usePurchaseCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.purchase.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function usePurchaseFindManyWithCount<
  T extends Prisma.purchaseFindManyArgs,
  R extends { data: GetFindResult<Prisma.$purchasePayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.purchaseFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['usePurchaseFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.purchase.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function usePurchaseFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['usePurchaseFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.purchase.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
