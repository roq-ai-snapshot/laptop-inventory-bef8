...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`laptop inventory application`}</title>

        <meta
          name="description"
          content="Laptop Inventory Application - Streamlining Your Tech Assets Management. Experience an Effortless Way to Track, Monitor, and Optimize Your Laptop Inventory."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxsYXB0b3B8ZW58MHx8fHwxNjk4MDU1MDM1fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`laptop inventory application`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Laptop Inventory Application - Streamlining Your Tech Assets Management. Experience an Effortless Way to Track, Monitor, and Optimize Your Laptop Inventory.`}
            </Text>
            <Box
